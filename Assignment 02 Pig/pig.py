...
and ask_yes_or_no(prompt) functions"""
    ...
    current_human_score = one_human_turn(current_human_score, human_score)
    if current_human_score == 0:
        return human_score
    else:
        return current_human_score

def one_human_turn(current_human_score, human_score):
    ...
    if ask_yes_or_no("Would you like to roll the die?\nPlease enter 'Y' or 'N':"):
        ...
        if num_rolled != 1:
            ...
            return one_human_turn(current_human_score, human_score)
        else:
            print ("Oh no! You rolled a 1.\nYou get no points this turn.")
            return 0
    else:
        print ("Your total score for this round is:", (current_human_score - human_score))
        return current_human_score
...
def ask_yes_or_no(prompt):
    """function asks human if they want to roll the die, returns True for Y/y and
False for N/n"""
